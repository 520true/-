	    ...
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/userinfo/userinfo.jsp' target='main'>修改个人密码</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>门店信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/mendianMana.action' target='main'>门店信息管理</a> </li>
	            <li><a href='<%=path %>/admin/mendian/mendianAdd.jsp' target='main'>门店信息添加</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	  ...
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/userinfo/userinfo1.jsp' target='main'>修改个人密码</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
